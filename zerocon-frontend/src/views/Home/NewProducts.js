...
function NewProducts({ items, addProduct }) {
    // console.log(items);
    return (
        <React.Fragment>
            <Container className="mt-5">
                <div data-aos="fade-up">
                    <h3 className="w-fit-content mx-auto text-uppercase border-bottom ff-russo-one"><span className="text-warning">New</span> products</h3>
