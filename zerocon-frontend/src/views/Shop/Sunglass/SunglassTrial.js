    ...
    const handleVideo = () => {
        ...
        trialInterval = setInterval(async () => {
            ...
            try {
                ...
                // canvasContext.drawImage(image, x, y, imgWidth, imgHeight);
                canvasContext.drawImage(image, x-(zoom/2)+positionX, y+positionY, imgWidth-5+zoom, imgHeight-10+zoom);
        ...
        <div className="sunglassTrial__bg-overlay p-5">
            <div className="sunglassTrial__content m-auto bg-light rounded p-3">
                ...
                <div className="position-relative">
                    <img className="d-none" id="productOverlayImage" src={props.id ? `${rootUrl}/media/sunglass-${props.id}-transparent.png` : sunglass_img} alt="Sunglass" />
